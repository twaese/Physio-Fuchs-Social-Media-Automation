# AGENTS.md – Projektanweisung Physio Fuchs Social Media

Zentrale Arbeitsanweisung für Codex in diesem Projekt.
...
Codex darf **niemals selbstständig** den Status auf `Geplant` oder
...
## 9. Was Codex **nicht** ohne Rückfrage tun darf
...
| Datum       | Änderung                                            | Wer            |
| ----------- | --------------------------------------------------- | -------------- |
| 2026-05-14  | Initialversion der AGENTS.md und Ordnerstruktur     | Codex / Thomas|
| 2026-05-14  | Status `Bereit` als 5. Status aufgenommen           | Codex / Thomas|
| 2026-05-14  | WF-04 (Monats-Scheduler) + Auto-Release-Sonderregel | Codex / Thomas|
| 2026-05-16  | Vollautomatik: Freigabe-Schritt entfernt, Status    | Codex / Thomas|
|             | `Geblockt` neu, HWG-Filter + 24h-Karenz als         |                |
|             | Notbremsen. Canva-Pipeline → Gotenberg+HTML.        |                |
| 2026-05-16  | Status `Wartet-auf-Avatar` ergänzt — Avatar-Branch  | Codex / Thomas|
|             | Avatar-ready, via `AVATAR_ENABLED`-Flag aktivierbar |                |
| 2026-05-17  | Layout v12 final (Foto + Banner + Ginkgo + Logo)    | Codex / Thomas|
| 2026-05-17  | WF-02 v18.2 live: GitHub-Push als public Bild-      | Codex / Thomas|
|             | Hosting (statt SP-URL, da Meta SP-Auth nicht kann). |                |
|             | `GITHUB_TOKEN` als neue Env-Var ergänzt.            |                |
| 2026-05-17  | WF-03 v6 live: Karenz + Schedule-Filter + Meta      | Codex / Thomas|
...
| 2026-05-17  | Doku komplett aktualisiert (WF-02, WF-03, README,   | Codex         |
|             | Workflow-Konzept, Session 18.5.)                    |                |
| 2026-05-18  | Erster vollautomatischer Post: PF-2026-001 ohne     | Codex / Thomas|
|             | manuellen Eingriff durch WF-02 → WF-03 → IG+FB live.|                |
|             | Timezone-Bug in FilterKZ behoben (Berlin-Offset).   |                |
| 2026-05-18  | WF-02 Merge-Code Doppel-Bug behoben: `.item`        | Codex / Thomas|
|             | → `.first()` + field_9 → field_8. Bild_Dateiname    |                |
|             | wird nun automatisch befüllt. Mit PF-2026-007       |                |
|             | verifiziert. Pipeline 100% selbstheilend.           |                |
| 2026-05-18  | Hashtag-Dopplung in IG-Caption gefixt: WF-02        | Codex / Thomas|
