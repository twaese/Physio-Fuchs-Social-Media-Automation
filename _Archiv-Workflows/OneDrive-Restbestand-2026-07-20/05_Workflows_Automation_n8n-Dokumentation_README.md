...
| WF-01 | Formular → SharePoint + Teams   | `PF_WF-01_v4_FotoVideoUpload.json`          | Webhook-Empfang, Foto-/Video-Upload, SharePoint-Item mit Status `Entwurf` oder `Video eingegangen` |
...
| WF-05 | Reel Caption Generator          | `PF_WF-05_Reel_Caption_Generator.json`      | Video-Items mit Status `Video eingegangen` → KI-Texte fertig |
| WF-06 | Reel Posting                    | `PF_WF-06_Reel_Posting.json`                | Nur `Reel freigegeben` + Judith + Public Video URL → Instagram Reel / Facebook Page Video |
...
```
Judith ──► HTML-Formular ──► WF-01 v4 ──► SharePoint (Status: Video eingegangen)
                                          │
                                  WF-05 Reel Caption Generator:
                                  - Claude erzeugt Hook, Caption, CTA, Hashtags
                                  - Status: KI-Texte fertig
                                          │
                                  Canva manuell + Hostinger Public MP4
                                          │
                                  Judith setzt Status: Reel freigegeben
                                          │
                                  WF-06 Reel Posting:
                                  - Preflight: Judith + Caption + Video_Public_URL
                                  - IG Reel + Facebook Page Video
...
- `WF-05_Reel-Caption-Generator.md`
- `WF-06_Reel-Posting.md`
- `README_CODEX_VIDEO_WORKFLOW.md`
- `VIDEO_REEL_BETRIEBSANLEITUNG.md`
- `VIDEO_REEL_ABLAUF_JUDITH.md`
- `VIDEO_REEL_TECHNIKABLAUF_THOMAS.md`
...
- WF-06 v2: echter Facebook-Reel-Upload statt Facebook Page Video
- WF-07: Insights-Sync (Reach/Likes/Saves zurück in SharePoint)
- WF-08: Kommentar-Monitor (DM/Comment-Triage in Teams)
